...
class _MapViewState extends State<MapView> {
  ...
  Future<void> _initializeMap() async {
    try {
      ...
      // Map initialization failed; user can retry by reopening the screen.
    }
  }
  ...
  Future<void> _setupAnnotationManagers() async {
    try {
      ...
      // Annotation manager setup failed; markers may be unavailable.
    }
  }
  ...
  Future<void> _createNavigationRoute({
    ...
    try {
      ...
      // Route drawing failed; user can try again.
    }
  }
