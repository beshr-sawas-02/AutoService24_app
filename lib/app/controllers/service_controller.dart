...
class ServiceController extends GetxController {
  ...
  Future<void> loadServices({String? serviceType}) async {
    try {
      ...
      print('🟠 services.value: ${services.length} خدمة');

      _applyFilters();

      print('🟡 filteredServices.value: ${filteredServices.length} خدمة');
    } catch (e) {
  ...
  Future<void> loadMoreServices({String? serviceType}) async {
    ...
    try {
      ...
      print('🟠 services.value بعد الإضافة: ${services.length} خدمة');
  ...
  Future<void> loadOwnerServices({String? serviceType}) async {
    try {
      ...
      print('🟠 ownerServices.value: ${ownerServices.length} خدمة');
    } catch (e) {
  ...
  Future<void> loadMoreOwnerServices({String? serviceType}) async {
    ...
    try {
      ...
      print('🟠 ownerServices بعد الإضافة: ${ownerServices.length} خدمة');
    } catch (e) {
